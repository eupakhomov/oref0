...
curl -s https://raw.githubusercontent.com/eupakhomov/oref0/$BRANCH/bin/openaps-packages.sh | bash -
mkdir -p ~/src; cd ~/src && git clone git://github.com/eupakhomov/oref0.git ; (cd oref0 && git checkout $BRANCH && git pull)
